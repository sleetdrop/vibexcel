...
- the five player sheets use native worksheet protection so fixed clue formulas cannot be accidentally cleared; only player input centers and the Coach selector are editable;
